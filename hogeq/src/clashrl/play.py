...
def play(cfg) -> None:
    ...
    # L67o hogeq port: hand-ported from icebow (the file is DECK_SPECIFIC); the only intended difference
    # is the student_deck default, hogeq. The student never selects the Mighty Miner ability.
    _student = None

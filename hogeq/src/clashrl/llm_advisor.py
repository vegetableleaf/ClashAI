...
class LLMAdvisor:
    ...
    def _ask(self, situation: str, hand: list, elixir: float, plan: bool):
        ...
        prompt = (
            ...
            "STEP 2 -- NOTHING TO ANSWER? Then 'hold' is almost always WRONG. The SEND ladder:\n"
            "- PUNISH: they just committed a tank in the back or a pump -> hog_rider at the "
            "OPPOSITE-lane bridge immediately, even at 4 elixir.\n"
            "- COUNTER-PUSH: your defence just survived -> hog_rider SAME lane, behind the "
            "survivor.\n"
            "- OUTCYCLED: their building or hard counter was just spent and is out of rotation, "
            "AND your answer to their remaining counter is in hand -> send at 4-5.\n"
            "- QUIET BOARD: single elixir send at 7+ (keeps 3 banked); at 10 ALWAYS act; double "
            "elixir send at 4+ and cycle at maximum speed.\n"
            "- under the bar: cycle skeletons or ice_spirit in the back rather than sit.\n"
            "- 'hold' ONLY on a QUIET board, and only if: under 3 elixir; or their building is "
            "in cycle and your "
            "earthquake is NOT in hand; or their skeleton-army is in cycle and your log is NOT "
            "in hand; or single elixir and they hold TWO fresh hard counters. While holding, "
            "firecracker behind the king is the bank play.\n\n"
            ...
            "hog_rider, mighty_miner, skeletons, the_log and earthquake can NEVER touch a flying "
            "unit. Air is answered by firecracker, tesla, or ice_spirit (the freeze works on "
            "air).\n"
            "wall_breakers: the_log or skeletons the moment they cross -- never overspend on "
            "2-elixir bodies.\n\n"

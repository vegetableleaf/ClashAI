...
ap.add_argument("--out", required=True); ap.add_argument("--leg", default="doctrine"); ap.add_argument("--ckpt", default=None); ap.add_argument("--override", default=None)
args = ap.parse_args()
...
import importlib
if args.override: importlib.import_module(args.override).install()
...
if args.leg.startswith("doctrine"):
    s = Doctrine()
else:

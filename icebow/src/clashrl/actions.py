...
class ActionSpace:
    ...
    def coords_to_grid(self, nx: float, ny: float):
        ...
        # so the two were only inverses when the warp was off. MEASURED with it on (live): the
        # round trip was wrong on 22 of 24 rows and up to 3 rows out, always toward the enemy end.
        #

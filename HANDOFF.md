...
Last updated: **2026-09-05 14:4x UTC**, branch `main` (**§5cs.33: OWNER PIVOT TO IMITATION LEARNING -- IL audit, crawl wave 3 +88 replays (608), BC dataset v1 6,922 pro placements from sim-reconstructed boards, c2r_best pro-cell agreement 3.3% top-1 / 10.9% top-5; sandbox engine (§5ax) is the BC-v2 state source; OPEN: stop arm E after m5k?**; §5cs.32: arm G collapsed m5k->m10k, ARM E running since 13:0x UTC; §5cs.31: AND credit form).
